#Implementation of a simple game of Blackjack
...
#class to have some basic ID functions and then some functions to grab the suit and rank of the card
class Card:
...
# hand class, this will have functions to take into account the Ace situation
class Hand:
    ...
    def __str__(self):
        '''return a string of current hand competition'''
        hand_comp = ""
...
#making a bet abd checking if the bet amount is within the integer
...
#function to set up the game and dealing out cards
...
'''the following code will initiate the game!(Note: Need to Run all the cells)'''
# Create a Deck
deck = Deck()
#Shuffle it
deck.shuffle()
